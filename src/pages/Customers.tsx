...
const Customers = () => {
  ...
  // Mock data pelanggan
  const customers = [
    { id: 'SIN-001', name: 'Budi Santoso', address: 'RT 01 RW 02, Dusun Krajan', phone: '081234567890', package: 'Home 10Mbps', status: 'Aktif' },
    { id: 'SIN-002', name: 'Siti Aminah', address: 'RT 03 RW 02, Dusun Krajan', phone: '082345678901', package: 'Home 20Mbps', status: 'Aktif' },
    { id: 'SIN-003', name: 'Agus Setiawan', address: 'RT 01 RW 01, Dusun Kidul', phone: '083456789012', package: 'Home 10Mbps', status: 'Non-Aktif' },
    { id: 'SIN-004', name: 'Dewi Lestari', address: 'RT 02 RW 01, Dusun Kidul', phone: '084567890123', package: 'Home 50Mbps', status: 'Aktif' },
  ];
